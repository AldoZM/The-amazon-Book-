...
es el recorrido en pre-order de un árbol binario y el segundo es su recorrido en
in-order, reconstruye y devuelve el árbol binario original. (Se garantiza que no
...
forma de cada lista:
\begin{itemize}
    \item \textbf{Pre-order:} anota primero la raíz y luego lo demás: \texttt{[RAÍZ, [Subárbol Izquierdo], [Subárbol Derecho]]}. Su primer elemento siempre es el jefe del árbol.
    \item \textbf{In-order:} anota primero todo lo de la izquierda, luego la raíz y al final lo de la derecha: \texttt{[[Subárbol Izquierdo], RAÍZ, [Subárbol Derecho]]}.
\end{itemize}
