...
\emph{min-heap} (o cola de prioridad), que es como una fila mágica que
...
\begin{enumerate}
  \item Metemos a \texttt{k} en el min-heap con tiempo $0$.
...
revisamos cada conexión y, cada vez que metemos algo en el min-heap,
...
manejas las entradas ``viejas'' del min-heap. Como en la cola de prioridad de C++
